...
def banner():
    ...
    os.system("figlet -f slant 'PHANIT WIFI TOOL'")
    print(Fore.YELLOW + "="*50)
    print(Fore.CYAN + "[1] Start Monitor Mode (BY NIT)")
    print(Fore.CYAN + "[2] Scan & Select WiFi (BY NIT)")
    print(Fore.CYAN + "[3] Spam Fake WiFi (RANDOM SSID)")
    print(Fore.CYAN + "[4] Deauth Entire WiFi Network (BY NIT)")
    print(Fore.CYAN + "[5] Stop All Processes (BY NIT)")
    print(Fore.CYAN + "[6] Stop wlan0 & Exit. (BY NIT)")
    print(Fore.YELLOW + "="*50)
